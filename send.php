...
{*/
    ...
    $mail->AddReplyTo("admin@raten.mcdir.ru","Просто Сварка");
    $mail->SetFrom('admin@raten.mcdir.ru', 'Просто Сварка');

    $address = "rateno@mail.ru";
    $mail->AddAddress($address, "Просто Сварка");
